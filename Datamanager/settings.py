...
TAG_APPROXMAX_COLS = 15 
TAG_APPROXMAXCOLS_COMPLEMENT = 19

TAG_FONT_TITLE = '/usr/share/fonts/truetype/liberation/LiberationMono-Bold.ttf'
TAG_FONT_COMPLEMENT = '/usr/share/fonts/truetype/liberation/LiberationMono-Italic.ttf'
...
TAG_INSTANCEDETAIL_HEIGHT = 50 * SCALE_FACTOR
...
PATH_MEDIA_BUNDLES = 'images/bundles/'
PATH_TAGDIR = 'tag/'
