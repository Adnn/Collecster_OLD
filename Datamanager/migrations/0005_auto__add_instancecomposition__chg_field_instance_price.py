...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstanceComposition'
        db.create_table('Datamanager_instancecomposition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('container_instance', self.gf('django.db.models.fields.related.ForeignKey')(related_name='container_instance', to=orm['Datamanager.Instance'])),
            ('element_instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.Instance'])),
        ))
        db.send_create_signal('Datamanager', ['InstanceComposition'])


        # Changing field 'Instance.price'
        db.alter_column('Datamanager_instance', 'price', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Deleting model 'InstanceComposition'
        db.delete_table('Datamanager_instancecomposition')


        # Changing field 'Instance.price'
        db.alter_column('Datamanager_instance', 'price', self.gf('django.db.models.fields.FloatField')(default=0))
