...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstancePicture.attribute'
        db.add_column('Datamanager_instancepicture', 'attribute',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'InstancePicture.attribute'
        db.delete_column('Datamanager_instancepicture', 'attribute_id')
