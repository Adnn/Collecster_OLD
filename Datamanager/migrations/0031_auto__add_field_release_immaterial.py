...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.immaterial'
        db.add_column('Datamanager_release', 'immaterial',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Release.immaterial'
        db.delete_column('Datamanager_release', 'immaterial')
