...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Datamanager_application', (
        ...
        db.send_create_signal('Datamanager', ['Application'])

        # Adding model 'ApplicationSpecifics'
        db.create_table('Datamanager_applicationspecifics', (
        ...
        db.send_create_signal('Datamanager', ['ApplicationSpecifics'])


    def backwards(self, orm):
        # Deleting model 'Application'
        db.delete_table('Datamanager_application')

        # Deleting model 'ApplicationSpecifics'
        db.delete_table('Datamanager_applicationspecifics')
    ...
    models = {
        ...
        'Datamanager.application': {
            'Meta': {'object_name': 'Application', '_ormbases': ['Datamanager.Release']},
            'loose': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'Datamanager.applicationspecifics': {
            'Meta': {'object_name': 'ApplicationSpecifics'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Datamanager.Instance']", 'unique': 'True'}),
            'working': ('django.db.models.fields.CharField', [], {'default': "u'?'", 'max_length': '1'})
        },
        ...
        'Datamanager.demo': {
            ...
            'loose': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'platform': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Datamanager.Platform']"}),
            'playable_games': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'demo_playable_game'", 'blank': 'True', 'to': "orm['Datamanager.Concept']"}),
            'publisher': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Datamanager.Company']", 'null': 'True', 'blank': 'True'}),
            'region': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'release_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['Datamanager.Release']", 'unique': 'True', 'primary_key': 'True'}),
            'video_games': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'demo_video_game'", 'blank': 'True', 'to': "orm['Datamanager.Concept']"})
        },
