...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Accessory.quantity'
        db.add_column('Datamanager_accessory', 'quantity',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Accessory.quantity'
        db.delete_column('Datamanager_accessory', 'quantity')
