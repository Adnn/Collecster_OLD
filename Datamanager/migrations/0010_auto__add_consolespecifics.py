...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConsoleSpecifics'
        db.create_table('Datamanager_consolespecifics', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.Instance'], unique=True)),
            ('modded', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('Datamanager', ['ConsoleSpecifics'])


    def backwards(self, orm):
        # Deleting model 'ConsoleSpecifics'
        db.delete_table('Datamanager_consolespecifics')
