...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Platform.abbreviated'
        db.alter_column('Datamanager_platform', 'abbreviated', self.gf('django.db.models.fields.CharField')(max_length=8, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Platform.abbreviated'
        db.alter_column('Datamanager_platform', 'abbreviated', self.gf('django.db.models.fields.CharField')(default='', max_length=8, unique=True))
