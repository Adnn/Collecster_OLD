...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Platform.brand'
        db.add_column('Datamanager_platform', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Datamanager.Company']),
                      keep_default=False)

        # Adding field 'Platform.generation'
        db.add_column('Datamanager_platform', 'generation',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Platform.arcade'
        db.add_column('Datamanager_platform', 'arcade',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Platform.abbreviated'
        db.add_column('Datamanager_platform', 'abbreviated',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=8, blank=True),
                      keep_default=False)

        # Adding field 'Platform.canonical_platform'
        db.add_column('Datamanager_platform', 'canonical_platform',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.Platform'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Platform.name'
        db.alter_column('Datamanager_platform', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30))

    def backwards(self, orm):
        # Deleting field 'Platform.brand'
        db.delete_column('Datamanager_platform', 'brand_id')

        # Deleting field 'Platform.generation'
        db.delete_column('Datamanager_platform', 'generation')

        # Deleting field 'Platform.arcade'
        db.delete_column('Datamanager_platform', 'arcade')

        # Deleting field 'Platform.abbreviated'
        db.delete_column('Datamanager_platform', 'abbreviated')

        # Deleting field 'Platform.canonical_platform'
        db.delete_column('Datamanager_platform', 'canonical_platform_id')


        # Changing field 'Platform.name'
        db.alter_column('Datamanager_platform', 'name', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True))
    ...
    models = {
        ...
        'Datamanager.platform': {
            ...
            'abbreviated': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '8', 'blank': 'True'}),
