...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GameSpecifics.blister'
        db.add_column('Datamanager_gamespecifics', 'blister',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GameSpecifics.blister'
        db.delete_column('Datamanager_gamespecifics', 'blister')
    ...
    models = {
        ...
        'Datamanager.gamespecifics': {
            ...
            'blister': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Datamanager.Instance']", 'unique': 'True'}),
            'working': ('django.db.models.fields.CharField', [], {'default': "u'?'", 'max_length': '1'})
        },
