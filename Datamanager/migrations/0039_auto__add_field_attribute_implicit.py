...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attribute.implicit'
        db.add_column('Datamanager_attribute', 'implicit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attribute.implicit'
        db.delete_column('Datamanager_attribute', 'implicit')
