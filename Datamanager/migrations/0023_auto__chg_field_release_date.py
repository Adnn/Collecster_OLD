...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('Datamanager_release', 'date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Release.date'
        raise RuntimeError("Cannot reverse this migration. 'Release.date' and its values cannot be restored.")
