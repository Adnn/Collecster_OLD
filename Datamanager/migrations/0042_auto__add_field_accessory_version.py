...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Accessory.version'
        db.add_column('Datamanager_accessory', 'version',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Accessory.version'
        db.delete_column('Datamanager_accessory', 'version')
