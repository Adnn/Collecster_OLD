...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Location', fields ['city']
        db.delete_unique('Datamanager_location', ['city'])

        # Adding unique constraint on 'Location', fields ['country', 'city']
        db.create_unique('Datamanager_location', ['country', 'city'])


    def backwards(self, orm):
        # Removing unique constraint on 'Location', fields ['country', 'city']
        db.delete_unique('Datamanager_location', ['country', 'city'])

        # Adding unique constraint on 'Location', fields ['city']
        db.create_unique('Datamanager_location', ['city'])
