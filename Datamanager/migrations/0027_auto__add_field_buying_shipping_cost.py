...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Buying.shipping_cost'
        db.add_column('Datamanager_buying', 'shipping_cost',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Buying.shipping_cost'
        db.delete_column('Datamanager_buying', 'shipping_cost')
