...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ComboPack'
        db.create_table('Datamanager_combopack', (
            ...
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.Company'], null=True, blank=True)),
        ))
        db.send_create_signal('Datamanager', ['ComboPack'])

        # Adding M2M table for field related_platforms on 'ComboPack'
        db.create_table('Datamanager_combopack_related_platforms', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('combopack', models.ForeignKey(orm['Datamanager.combopack'], null=False)),
            ('platform', models.ForeignKey(orm['Datamanager.platform'], null=False))
        ))
        db.create_unique('Datamanager_combopack_related_platforms', ['combopack_id', 'platform_id'])


    def backwards(self, orm):
        # Deleting model 'ComboPack'
        db.delete_table('Datamanager_combopack')

        # Removing M2M table for field related_platforms on 'ComboPack'
        db.delete_table('Datamanager_combopack_related_platforms')
