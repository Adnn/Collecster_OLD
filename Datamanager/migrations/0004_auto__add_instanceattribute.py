...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Datamanager_instanceattribute', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.Instance'])),
            ('attribute', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.Attribute'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal('Datamanager', ['InstanceAttribute'])


    def backwards(self, orm):
        # Deleting model 'InstanceAttribute'
        db.delete_table('Datamanager_instanceattribute')
