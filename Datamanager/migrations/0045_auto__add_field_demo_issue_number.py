...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demo.issue_number'
        db.add_column('Datamanager_demo', 'issue_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demo.issue_number'
        db.delete_column('Datamanager_demo', 'issue_number')
