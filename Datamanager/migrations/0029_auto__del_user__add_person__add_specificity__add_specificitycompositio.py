...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Person'
        db.create_table('Datamanager_person', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal('Datamanager', ['Person'])

        # Adding model 'Specificity'
        db.create_table('Datamanager_specificity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
        ))
        db.send_create_signal('Datamanager', ['Specificity'])

        # Adding model 'SpecificityComposition'
        db.create_table('Datamanager_specificitycomposition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('specificity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.Specificity'])),
            ('release', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.Release'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal('Datamanager', ['SpecificityComposition'])


        # Changing field 'Instance.owner'
        db.alter_column('Datamanager_instance', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.Person']))
        # Deleting field 'Release.specificity'
        db.delete_column('Datamanager_release', 'specificity')

        # Adding field 'Release.specificity_text'
        db.add_column('Datamanager_release', 'specificity_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)


        # Changing field 'Donation.donator'
        db.alter_column('Datamanager_donation', 'donator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.Person']))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('Datamanager_person')

        # Deleting model 'Specificity'
        db.delete_table('Datamanager_specificity')

        # Deleting model 'SpecificityComposition'
        db.delete_table('Datamanager_specificitycomposition')


        # Changing field 'Instance.owner'
        db.alter_column('Datamanager_instance', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.User']))
        # Adding field 'Release.specificity'
        db.add_column('Datamanager_release', 'specificity',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)

        # Deleting field 'Release.specificity_text'
        db.delete_column('Datamanager_release', 'specificity_text')


        # Changing field 'Donation.donator'
        db.alter_column('Datamanager_donation', 'donator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.User']))
