...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstanceAttribute.value'
        db.alter_column('Datamanager_instanceattribute', 'value', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'InstanceAttribute.value'
        raise RuntimeError("Cannot reverse this migration. 'InstanceAttribute.value' and its values cannot be restored.")
    ...
    models = {
        ...
        'Datamanager.instanceattribute': {
            ...
            'value': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'})
        },
