...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DemoSpecifics'
        db.create_table('Datamanager_demospecifics', (
        ...
        db.send_create_signal('Datamanager', ['DemoSpecifics'])

        # Adding model 'Demo'
        db.create_table('Datamanager_demo', (
            ...
            ('loose', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('platform', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.Platform'])),
            ('publisher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.Company'], null=True, blank=True)),
        ))
        db.send_create_signal('Datamanager', ['Demo'])

        # Adding M2M table for field playable_games on 'Demo'
        db.create_table('Datamanager_demo_playable_games', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('demo', models.ForeignKey(orm['Datamanager.demo'], null=False)),
            ('concept', models.ForeignKey(orm['Datamanager.concept'], null=False))
        ))
        db.create_unique('Datamanager_demo_playable_games', ['demo_id', 'concept_id'])

        # Adding M2M table for field video_games on 'Demo'
        db.create_table('Datamanager_demo_video_games', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('demo', models.ForeignKey(orm['Datamanager.demo'], null=False)),
            ('concept', models.ForeignKey(orm['Datamanager.concept'], null=False))
        ))
        db.create_unique('Datamanager_demo_video_games', ['demo_id', 'concept_id'])


    def backwards(self, orm):
        # Deleting model 'DemoSpecifics'
        db.delete_table('Datamanager_demospecifics')

        # Deleting model 'Demo'
        db.delete_table('Datamanager_demo')

        # Removing M2M table for field playable_games on 'Demo'
        db.delete_table('Datamanager_demo_playable_games')

        # Removing M2M table for field video_games on 'Demo'
        db.delete_table('Datamanager_demo_video_games')
    ...
    models = {
        ...
        'Datamanager.concept': {
            'Meta': {'ordering': "('common_name',)", 'object_name': 'Concept'},
        ...
        'Datamanager.demo': {
            'Meta': {'object_name': 'Demo', '_ormbases': ['Datamanager.Release']},
            'loose': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'platform': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Datamanager.Platform']"}),
            'playable_games': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'demo_playable_game'", 'symmetrical': 'False', 'to': "orm['Datamanager.Concept']"}),
            'publisher': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Datamanager.Company']", 'null': 'True', 'blank': 'True'}),
            'region': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'release_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['Datamanager.Release']", 'unique': 'True', 'primary_key': 'True'}),
            'video_games': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'demo_video_game'", 'symmetrical': 'False', 'to': "orm['Datamanager.Concept']"})
        },
        'Datamanager.demospecifics': {
            'Meta': {'object_name': 'DemoSpecifics'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Datamanager.Instance']", 'unique': 'True'}),
            'working': ('django.db.models.fields.CharField', [], {'default': "u'?'", 'max_length': '1'})
        },
