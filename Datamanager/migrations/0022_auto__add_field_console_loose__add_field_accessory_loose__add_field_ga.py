...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Console.loose'
        db.add_column('Datamanager_console', 'loose',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Accessory.loose'
        db.add_column('Datamanager_accessory', 'loose',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Game.loose'
        db.add_column('Datamanager_game', 'loose',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Console.loose'
        db.delete_column('Datamanager_console', 'loose')

        # Deleting field 'Accessory.loose'
        db.delete_column('Datamanager_accessory', 'loose')

        # Deleting field 'Game.loose'
        db.delete_column('Datamanager_game', 'loose')
