...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Platform.generation'
        db.alter_column('Datamanager_platform', 'generation', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Platform.generation'
        raise RuntimeError("Cannot reverse this migration. 'Platform.generation' and its values cannot be restored.")
