...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstancePicture'
        db.create_table('Datamanager_instancepicture', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Datamanager.Instance'])),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('Datamanager', ['InstancePicture'])


    def backwards(self, orm):
        # Deleting model 'InstancePicture'
        db.delete_table('Datamanager_instancepicture')
