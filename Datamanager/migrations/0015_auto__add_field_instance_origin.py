...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.origin'
        db.add_column('Datamanager_instance', 'origin',
                      self.gf('django.db.models.fields.CharField')(default='BC', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.origin'
        db.delete_column('Datamanager_instance', 'origin')
