...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Color'
        db.create_table('Datamanager_color', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
        ))
        db.send_create_signal('Datamanager', ['Color'])

        # Deleting field 'Console.color'
        db.delete_column('Datamanager_console', 'color')

        # Adding field 'Console.color_k'
        db.add_column('Datamanager_console', 'color_k',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Datamanager.Color']),
                      keep_default=False)

        # Deleting field 'Accessory.color'
        db.delete_column('Datamanager_accessory', 'color')

        # Adding M2M table for field colors on 'Accessory'
        db.create_table('Datamanager_accessory_colors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('accessory', models.ForeignKey(orm['Datamanager.accessory'], null=False)),
            ('color', models.ForeignKey(orm['Datamanager.color'], null=False))
        ))
        db.create_unique('Datamanager_accessory_colors', ['accessory_id', 'color_id'])


    def backwards(self, orm):
        # Deleting model 'Color'
        db.delete_table('Datamanager_color')
        ...
        # Deleting field 'Console.color_k'
        db.delete_column('Datamanager_console', 'color_k_id')

        # Adding field 'Accessory.color'
        db.add_column('Datamanager_accessory', 'color',
                      self.gf('django.db.models.fields.CharField')(default='BLK', max_length=3),
                      keep_default=False)

        # Removing M2M table for field colors on 'Accessory'
        db.delete_table('Datamanager_accessory_colors')
    ...
    models = {
        ...
        'Datamanager.console': {
            ...
            'color_k': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Datamanager.Color']"}),
