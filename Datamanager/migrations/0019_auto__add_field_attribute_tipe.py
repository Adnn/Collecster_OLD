...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attribute.tipe'
        db.add_column('Datamanager_attribute', 'tipe',
                      self.gf('django.db.models.fields.CharField')(default='RTG', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attribute.tipe'
        db.delete_column('Datamanager_attribute', 'tipe')
